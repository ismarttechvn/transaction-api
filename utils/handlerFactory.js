...
exports.getOne = (Model, include) => catchAsync(async (request, response, next) => {
  ...
  if (!document) throw new AppError(StatusCode.Code.NOT_FOUND_DOCUMENT);
